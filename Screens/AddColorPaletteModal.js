...
import { View, Text, TextInput, StyleSheet, FlatList, Switch, Alert } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={styles.eachSwitch}>
                        <Text>{item.colorName}</Text>
                        <Switch value={!!selectedColors.find((color) => color.colorName === item.colorName)} onValueChange={isSelected => handleUpdate(item, isSelected)} />
                    </View>
                )}
            />
